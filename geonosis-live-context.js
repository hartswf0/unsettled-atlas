...
function geoCtxSignal(r){
  var p=r.properties||{},x={id:r.id,kind:r.kind,epistemic:r.epistemic||'RECORD',observed_at:geoCtxIso(r.observedAt),retrieved_at:geoCtxIso(r.retrievedAt)};
